...
var getDateRange = function () {
    ...
    var startDate = new Date(2021, 2, 11).getTime(); //2021-03-11
    var endDate = new Date().getTime() - oneDay; //yesterday
